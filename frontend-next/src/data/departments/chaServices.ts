...
export const chaServices: DepartmentDefinition = {
    ...
    fields: [
        ...
        { key: "stuffing_type", label: "Stuffing Type", type: "select", required: false, options: ["Factory Stuffing", "Dock Stuffing"], default: "Dock Stuffing", rules: { visible_if: { mode: "FCL" } }, halfWidth: true },
        { key: "clearance_scope", label: "Clearance Scope", type: "select", required: true, options: ["Export customs clearance", "Import customs clearance", "Both export and import"], halfWidth: true },
        { key: "commodity_description", label: "Commodity", type: "multiline", required: true },
        { key: "cargo_value", label: "Cargo Value", type: "text", required: false, halfWidth: true },
        ...
        { key: "num_packages", label: "No. of Packages", type: "text", required: true, rules: { visible_if: { mode: ["AIR", "LCL"] } }, halfWidth: true },
        { key: "dimensions", label: "Dimensions per Package", type: "text", required: false, rules: { visible_if: { mode: ["AIR", "LCL"] } }, halfWidth: true },
        { key: "gross_weight_kg", label: "Gross Weight", type: "text", required: true, halfWidth: true },
        { key: "hsn_codes", label: "HSN Code(s)", type: "text", required: false, ui: { placeholder: "Enter HSN code(s)" }, halfWidth: true },
