...
export const destinationCharges: DepartmentDefinition = {
    ...
    fields: [
        ...
        { key: "destination", label: "Destination Port / Place", type: "text", required: true, halfWidth: true },
        ...
        { key: "charge_scope", label: "Charge Scope", type: "select", required: true, options: ["Destination local charges", "Destination THC and handling", "Import documentation and release"], halfWidth: true },
        { key: "delivery_address", label: "Delivery Address", type: "text", required: false, ui: { placeholder: "Final delivery address (for DDP/DDU)" } },
