...
export const oceanFreight: DepartmentDefinition = {
    id: "ocean_freight",
    name: "Ocean Freight",
    group: "Ocean Freight",
    fields: [
        ...
        { key: "mode", label: "Mode", type: "select", required: true, options: ["FCL", "LCL"], default: "FCL", halfWidth: true },
        ...
        { key: "free_days", label: "Free Days Required", type: "text", required: false, default: "14 days", rules: { visible_if: { mode: "FCL" } }, halfWidth: true },
        { key: "num_packages", label: "No. of Packages", type: "text", required: true, rules: { visible_if: { mode: "LCL" } }, halfWidth: true },
        { key: "dimensions", label: "Dimensions (L x W x H in cm)", type: "multiline", required: true, ui: { placeholder: "Example: 120 x 80 x 95 cm, 2 packages" }, rules: { visible_if: { mode: "LCL" } } },
        ...
        { key: "stackable", label: "Stackable", type: "radio", required: true, options: ["Yes", "No"], ui: { helpText: "Enter stackable yes or no" }, rules: { visible_if: { mode: "LCL" } }, halfWidth: true },
