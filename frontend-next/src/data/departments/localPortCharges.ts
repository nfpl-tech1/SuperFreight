...
export const localPortCharges: DepartmentDefinition = {
    ...
    fields: [
        ...
        { key: "source", label: "Port / Origin", type: "text", required: true, halfWidth: true },
        ...
        { key: "charge_scope", label: "Charge Scope", type: "select", required: true, options: ["Port handling", "Origin local charges", "Documentation and terminal charges"], halfWidth: true },
