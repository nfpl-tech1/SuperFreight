...
export class AppQuoteInboxFoundation2026041810000
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'DROP INDEX IF EXISTS "IDX_freight_quotes_rfqId_vendorId_isLatestVersion"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "IDX_freight_quotes_inboundMessageId"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "IDX_quote_inbound_messages_matchedVendorId"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "IDX_quote_inbound_messages_matchedRfqId"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "IDX_quote_inbound_messages_matchedInquiryId"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "IDX_quote_inbound_messages_status_receivedAt"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "IDX_quote_inbound_messages_receivedAt"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "IDX_quote_ignore_rules_isActive_priority"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "IDX_quote_ignore_rules_mailboxOwnerUserId_priority"',
    );
    ...
    await queryRunner.query(
      'DROP TABLE IF EXISTS "quote_mailbox_scan_states" CASCADE',
    );
  }
}
