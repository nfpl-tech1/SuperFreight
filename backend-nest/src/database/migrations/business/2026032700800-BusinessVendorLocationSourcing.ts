...
export class BusinessVendorLocationSourcing2026032700800 implements MigrationInterface {
  name = 'BusinessVendorLocationSourcing2026032700800';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await createUuidExtension(queryRunner);
    await createEnumTypeIfMissing(queryRunner, 'service_location_kind_enum', [
      'INLAND_CITY',
      'ICD',
      'CFS',
      'WAREHOUSE_ZONE',
    ...
    await createEnumTypeIfMissing(
      queryRunner,
      'import_source_audit_entitykind_enum',
      [
        'VENDOR',
        'OFFICE',
        'PORT',
    ...
    await createEnumTypeIfMissing(
      queryRunner,
      'import_source_audit_action_enum',
      ['CREATED', 'UPDATED', 'SKIPPED', 'REVIEW_REQUIRED'],
    );
    ...
    await addUniqueConstraintIfMissing(
      queryRunner,
      'region_master',
      'UQ_region_master_normalizedSectorName',
      ['normalizedSectorName'],
    );
    await createIndexIfMissing(
      queryRunner,
      'IDX_region_master_isActive',
      'region_master',
      '("isActive")',
    );
    ...
    await createIndexIfMissing(
      queryRunner,
      'IDX_country_region_map_regionId',
      'country_region_map',
      '("regionId")',
    );
    ...
    await createIndexIfMissing(
      queryRunner,
      'IDX_port_master_mode_country_name',
      'port_master',
      '("portMode", "normalizedCountryName", "normalizedName")',
    );
    await createIndexIfMissing(
      queryRunner,
      'IDX_port_master_normalizedCityName',
      'port_master',
      '("normalizedCityName")',
    );
    await createIndexIfMissing(
      queryRunner,
      'IDX_port_master_regionId',
      'port_master',
      '("regionId")',
    );
    ...
    await createIndexIfMissing(
      ...
      'service_location_master',
      '("locationKind", "normalizedCountryName", "normalizedName")',
    );
    await createIndexIfMissing(
      queryRunner,
      'IDX_service_location_master_city',
      'service_location_master',
      '("normalizedCityName")',
    );
    await createIndexIfMissing(
      queryRunner,
      'IDX_service_location_master_regionId',
      'service_location_master',
      '("regionId")',
    );
    ...
    await createIndexIfMissing(
      queryRunner,
      'IDX_service_location_alias_serviceLocationId',
      'service_location_alias',
      '("serviceLocationId")',
    );
    await createIndexIfMissing(
      queryRunner,
    ...
    await createIndexIfMissing(
      queryRunner,
      'IDX_vendor_office_service_locations_serviceLocationId',
      'vendor_office_service_locations',
      '("serviceLocationId")',
    );
    await queryRunner.query(`
    ...
    await createIndexIfMissing(
      queryRunner,
      'IDX_import_source_audit_source',
      'import_source_audit',
      '("sourceWorkbook", "sourceSheet", "sourceRowNumber")',
    );
    await createIndexIfMissing(
      queryRunner,
      'IDX_import_source_audit_entity',
      'import_source_audit',
      '("entityKind", "action")',
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await dropIndexIfExists(queryRunner, 'IDX_import_source_audit_entity');
    await dropIndexIfExists(queryRunner, 'IDX_import_source_audit_source');
    ...
    await queryRunner.query(
      `DROP TABLE IF EXISTS "vendor_office_service_locations"`,
    );
    ...
    await dropIndexIfExists(queryRunner, 'IDX_service_location_master_city');
    await dropIndexIfExists(
      queryRunner,
      'IDX_service_location_master_kind_country_name',
    );
    ...
    await dropIndexIfExists(queryRunner, 'IDX_port_alias_portId');
    await queryRunner.query(`DROP TABLE IF EXISTS "port_alias"`);

    await dropIndexIfExists(queryRunner, 'IDX_port_master_regionId');
    await dropIndexIfExists(queryRunner, 'IDX_port_master_normalizedCityName');
    await dropIndexIfExists(queryRunner, 'IDX_port_master_mode_country_name');
    await queryRunner.query(`
      ALTER TABLE "port_master"
    ...
    await dropIndexIfExists(queryRunner, 'IDX_country_region_map_regionId');
    await dropConstraintIfExists(
      queryRunner,
      'country_region_map',
      'UQ_country_region_map_normalizedCountryName_regionId',
    ...
    await dropIndexIfExists(queryRunner, 'IDX_region_master_isActive');
    await dropConstraintIfExists(
      queryRunner,
      'region_master',
      'UQ_region_master_normalizedSectorName',
    ...
    await dropEnumTypeIfExists(queryRunner, 'import_source_audit_action_enum');
    await dropEnumTypeIfExists(
      queryRunner,
      'import_source_audit_entitykind_enum',
    );
    await dropEnumTypeIfExists(queryRunner, 'service_location_kind_enum');
  }
}
