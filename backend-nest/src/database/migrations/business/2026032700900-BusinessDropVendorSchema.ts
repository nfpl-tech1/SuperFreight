...
import { dropEnumTypeIfExists } from '../migration-helpers';
...
export class BusinessDropVendorSchema2026032700900 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    const vendorPhase1 = new BusinessVendorMasterPhase12026032400400();
    const vendorLocationSourcing =
      new BusinessVendorLocationSourcing2026032700800();
