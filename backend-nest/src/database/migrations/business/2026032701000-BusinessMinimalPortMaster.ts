...
function cleanSeedValue(value: string) {
...
function buildMinimalPortSeeds(): Array<
  MinimalPortSeed & {
    code: string;
...
> {
  const seen = new Map<string, MinimalPortSeed>();
...
export class BusinessMinimalPortMaster2026032701000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await dropIndexIfExists(queryRunner, 'IDX_port_master_portMode_isActive');
