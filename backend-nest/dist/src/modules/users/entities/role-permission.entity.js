...
], RolePermission.prototype, "canView", void 0);
__decorate([
    (0, typeorm_1.Column)({ default: false }),
    __metadata("design:type", Boolean)
], RolePermission.prototype, "canEdit", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => app_role_entity_1.AppRole, (role) => role.permissions, { onDelete: 'CASCADE' }),
...
exports.RolePermission = RolePermission = __decorate([
    (0, typeorm_1.Index)('IDX_role_permissions_roleId', ['roleId']),
    (0, typeorm_1.Unique)('UQ_role_permissions_roleId_moduleKey', ['roleId', 'moduleKey']),
