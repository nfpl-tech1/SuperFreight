...
exports.default = () => ({
    ...
    appDatabase: {
        ...
        port: parseInt(process.env.APP_DB_PORT ?? process.env.DB_PORT ?? '5432', 10) ||
            5432,
        username: process.env.APP_DB_USERNAME || process.env.DB_USERNAME || 'postgres',
    ...
    businessDatabase: {
        host: process.env.BUSINESS_DB_HOST ||
            ...
            process.env.DB_HOST ||
            'localhost',
        port: parseInt(process.env.BUSINESS_DB_PORT ??
            process.env.APP_DB_PORT ??
            process.env.DB_PORT ??
            '5432', 10) || 5432,
        username: process.env.BUSINESS_DB_USERNAME ||
    ...
    jwt: {
        ...
        refreshCookieName: process.env.JWT_REFRESH_COOKIE_NAME || 'sf_refresh_token',
    },
    os: {
    ...
    microsoft: {
        ...
        redirectUri: process.env.MICROSOFT_REDIRECT_URI || 'http://localhost:3000/onboarding',
    ...
    quoteIntake: {
        enabled: process.env.QUOTE_INTAKE_ENABLED
            ...
            : true,
        pollIntervalMs: parseInt(process.env.QUOTE_INTAKE_POLL_INTERVAL_MS ?? '60000', 10) ||
            60000,
        overlapSeconds: parseInt(process.env.QUOTE_INTAKE_OVERLAP_SECONDS ?? '120', 10) || 120,
        initialLookbackHours: parseInt(process.env.QUOTE_INTAKE_INITIAL_LOOKBACK_HOURS ?? '24', 10) || 24,
        batchSize: parseInt(process.env.QUOTE_INTAKE_BATCH_SIZE ?? '50', 10) || 50,
    },
