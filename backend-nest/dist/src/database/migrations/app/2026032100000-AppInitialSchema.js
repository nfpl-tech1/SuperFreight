...
exports.AppInitialSchema2026032100000 = void 0;
const migration_helpers_1 = require("../migration-helpers");
class AppInitialSchema2026032100000 {
    name = 'AppInitialSchema2026032100000';
    async up(queryRunner) {
        await (0, migration_helpers_1.createUuidExtension)(queryRunner);
        await (0, migration_helpers_1.createEnumTypeIfMissing)(queryRunner, 'users_role_enum', [
            'ADMIN',
            'USER',
        ]);
        await (0, migration_helpers_1.createEnumTypeIfMissing)(queryRunner, 'user_departments_department_enum', ['IMPORT', 'EXPORT', 'INTERNATIONAL']);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query('DROP TABLE IF EXISTS "outlook_subscriptions" CASCADE');
        await queryRunner.query('DROP TABLE IF EXISTS "outlook_connections" CASCADE');
        ...
        await queryRunner.query('DROP TABLE IF EXISTS "consumed_sso_tokens" CASCADE');
        await queryRunner.query('DROP TABLE IF EXISTS "audit_logs" CASCADE');
        await queryRunner.query('DROP TABLE IF EXISTS "app_roles" CASCADE');
        await queryRunner.query('DROP TABLE IF EXISTS "users" CASCADE');
        await (0, migration_helpers_1.dropEnumTypeIfExists)(queryRunner, 'user_departments_department_enum');
        await (0, migration_helpers_1.dropEnumTypeIfExists)(queryRunner, 'users_role_enum');
    }
}
exports.AppInitialSchema2026032100000 = AppInitialSchema2026032100000;
//# sourceMappingURL=2026032100000-AppInitialSchema.js.map