...
exports.BusinessComprehensivePortMaster2026032801300 = void 0;
...
function buildCode(name, portMode, unlocode) {
    if (unlocode)
        return unlocode;
...
class BusinessComprehensivePortMaster2026032801300 {
    name = 'BusinessComprehensivePortMaster2026032801300';
    async up(queryRunner) {
        await queryRunner.query(`DELETE FROM "port_master" WHERE "sourceConfidence" IN ('MANUAL_DEMO', 'SEED_MINIMAL')`);
    ...
    async down(queryRunner) {
        await queryRunner.query(`DELETE FROM "port_master" WHERE "sourceConfidence" = 'SEED_COMPREHENSIVE'`);
    }
}
exports.BusinessComprehensivePortMaster2026032801300 = BusinessComprehensivePortMaster2026032801300;
//# sourceMappingURL=2026032801300-BusinessComprehensivePortMaster.js.map