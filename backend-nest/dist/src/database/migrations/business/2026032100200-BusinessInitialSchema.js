...
exports.BusinessInitialSchema2026032100200 = void 0;
const migration_helpers_1 = require("../migration-helpers");
class BusinessInitialSchema2026032100200 {
    name = 'BusinessInitialSchema2026032100200';
    async up(queryRunner) {
        await (0, migration_helpers_1.createUuidExtension)(queryRunner);
        await (0, migration_helpers_1.createEnumTypeIfMissing)(queryRunner, 'inquiries_inquirytype_enum', [
            'CHA_ONLY',
            'FREIGHT_ONLY',
            'CHA_FREIGHT',
        ]);
        await (0, migration_helpers_1.createEnumTypeIfMissing)(queryRunner, 'inquiries_status_enum', [
            'PENDING',
            'RFQ_SENT',
            'QUOTES_RECEIVED',
            'QUOTED_TO_CUSTOMER',
        ...
        await (0, migration_helpers_1.createEnumTypeIfMissing)(queryRunner, 'job_service_parts_parttype_enum', ['FREIGHT', 'CHA', 'TRANSPORTATION']);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query('DROP TABLE IF EXISTS "external_thread_refs" CASCADE');
        await queryRunner.query('DROP TABLE IF EXISTS "ownership_assignments" CASCADE');
        ...
        await (0, migration_helpers_1.dropEnumTypeIfExists)(queryRunner, 'job_service_parts_parttype_enum');
        await (0, migration_helpers_1.dropEnumTypeIfExists)(queryRunner, 'inquiries_status_enum');
        await (0, migration_helpers_1.dropEnumTypeIfExists)(queryRunner, 'inquiries_inquirytype_enum');
    }
}
exports.BusinessInitialSchema2026032100200 = BusinessInitialSchema2026032100200;
//# sourceMappingURL=2026032100200-BusinessInitialSchema.js.map